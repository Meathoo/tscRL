...
def build_config(args):
    ...
    model_overrides = {
        ...
        'mixer_mode': getattr(args, 'mixer_mode', None),
        'mixer_regimes': getattr(args, 'mixer_regimes', None),
        'mixer_quantize': getattr(args, 'mixer_quantize', None),
        'mixer_vq_coef': getattr(args, 'mixer_vq_coef', None),
